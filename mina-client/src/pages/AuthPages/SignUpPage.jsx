...
const SignUpPage = () => {
  ...
  return (
    <>
      <h1 className="text-3xl font-bold tracking-tight text-black sm:text-4xl">Sign Up</h1>
      ...
      <div className="mt-8 border-t border-zinc-200 pt-6 text-sm text-zinc-600">
        ...
        <Link to="/auth/signin" className="font-semibold text-black transition hover:text-zinc-600">
          Log In
        </Link>
      </div>
    </>
